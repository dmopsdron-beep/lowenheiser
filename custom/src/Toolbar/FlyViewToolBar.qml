            ...
            Item {
                ...
                RowLayout {
                    ...
                    RowLayout {
                        ...
                        // CUSTOM Löweheiser: logo "Lö" escalado a la altura completa de la
                        // barra (el QGCToolBarButton estándar lo encajaba en una caja cuadrada
                        // pequeña). Sigue abriendo el diálogo de selección de herramientas.
                        Item {
                            id:                     qgcButton
                            objectName:             "toolbar_qgcLogo"
                            Layout.fillHeight:      true
                            Layout.preferredWidth:  control.height * (104.0 / 72.0)
